...
describe('fetchCompanyProfile', () => {
    ...
    it('falls back to cached or minimal US profile when overview fails', async () => {
        ...
        const minimal = await fetchCompanyProfile({
            ticker: 'MSFT',
            market: 'US',
            fallbackCompanyName: 'Microsoft Corporation',
        });
